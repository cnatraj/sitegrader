...
CATEGORY 1 — CONVERSION SIGNALS (30 pts)
When AI sends someone to this site, they decide in 30 seconds whether to call.

1.1 Phone number visible at the top of the page (7 pts)
Search the first 20% of HTML for a phone number in the header or nav. Pass = 7, Fail = 0.

1.2 Phone number is tappable (3 pts)
Search entire HTML for href="tel:". Pass = 3, Fail = 0.

1.3 Book or call button at the top of the page (5 pts)
Search first 25% of HTML for a button or link with words: Schedule, Book, Call, Get, Request, Contact. Pass = 5, Fail = 0.
...
1.6 Emergency or same-day service mentioned (5 pts)
Search body text for: "24/7", "emergency", "same-day", "after hours", "24 hour". Pass = 5, Fail = 0.
...
// CATEGORY 2 — TECHNICAL HEALTH (removed — PageSpeed API not used)
// 2.1 Secure website (3 pts) — moved to Trust Signals as 4.6
// 2.2 How fast the site loads on a phone (8 pts) — required PageSpeed data
// 2.3 Time until the main content appears (5 pts) — required PageSpeed data
// 2.4 Whether the page jumps around while loading (4 pts) — required PageSpeed data


CATEGORY 3 — CONTENT DEPTH (25 pts)
AI matches businesses to searches based on how well the site answers real homeowner questions.

3.1 Number of individual service pages (8 pts)
...
7 or more = 8 pts. 5 to 6 = 5 pts. 3 to 4 = 3 pts. 1 to 2 = 0 pts.
...
3.5 Enough content on the homepage (7 pts)
Count words in main body text only (skip nav and footer).
800 or more = 7 pts. 400 to 799 = 4 pts. Under 400 = 0 pts.


CATEGORY 4 — TRUST SIGNALS (25 pts)
AI looks for proof the business is real and worth trusting before recommending it.

4.1 Star ratings or reviews on the site (6 pts)
Search for: rating numbers like "4.8", stars symbol, "review", "testimonial", or a reviews widget.
Rating + review count visible = 6 pts. Quotes only, no rating = 2 pts. Nothing = 0 pts.

4.2 Certifications and credentials (6 pts)
Search for: "NATE", "EPA", "BBB", "licensed", "certified", "insured", "bonded", "accredited".
3 or more = 6 pts. 1 to 2 = 3 pts. None = 0 pts.
...
4.6 Secure website (3 pts)
URL starts with https://. A site without HTTPS is a trust red flag for both customers and AI. Pass = 3, Fail = 0.


CATEGORY 5 — LOCAL PRESENCE (20 pts)
AI verifies a business is real and local before recommending it.

5.1 Full address and phone number in the footer (5 pts)
Parse footer HTML for a complete street address AND phone number together. Pass = 5, Fail = 0.

5.2 Hidden business info code on the site (8 pts)
...
HVAC or local business type WITH address and phone = 8 pts. Code present but incomplete = 3 pts. Nothing = 0 pts.
...
5.4 Business hours on the site (4 pts)
Search for: "Mon", "Monday", time patterns like "8am", "9:00", "hours", "open". Pass = 4, Fail = 0.
...

{
  ...
  "categories": {
    ...
    "content": { "score": 0, "max": 25, "label": "Content Depth", "items": [] },
    "trust": { "score": 0, "max": 25, "label": "Trust Signals", "items": [] },
    "local": { "score": 0, "max": 20, "label": "Local Presence", "items": [] }
  },
  "priority_fixes": [
    {
      "rank": 1,
